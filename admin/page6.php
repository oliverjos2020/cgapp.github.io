    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="page1.php"><span class="mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                    My Profile</a>  <a class="btn btn-sm btn-primary display-4" href="page4.php"><span class="mbrib-letter mbr-iconfont mbr-iconfont-btn"></span>Inbox</a>           <a class="btn btn-sm btn-primary display-4" href="page3.php"><span class="mobi-mbri mobi-mbri-layers mbr-iconfont mbr-iconfont-btn"></span>Notification</a> <a class="btn btn-sm btn-primary display-4" href="page2.php"><span class="mbri-logout mbr-iconfont mbr-iconfont-btn"></span>
                    Logout</a></div>
        </div>
    </nav>
</section>

<section class="testimonials4 cid-rRVqCVxcSJ" id="testimonials4-1c">
...
echo'<a href="page6.php?page='.$i.'">'.$i.'</a>';
    }
    echo"</div>";
?></center>
  </div>
