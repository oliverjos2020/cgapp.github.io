...
<button type="submit" class="btn btn-primary  display-4" name="submit">Submit</button>
             ...
             <?php
                            ...
                            $sql=("INSERT into church_administrator(user,pass) VALUES ('$user','$pass')");
...
$id=$_GET['delete'];
$sql=mysql_query("SELECT * FROM head_administrator WHERE id='$id'");
$row=mysql_fetch_array($sql);
}
if(isset($_POST['delete'])){
$id=$_POST['id'];
$sql="DELETE FROM head_administrator WHERE id='$id'";
$res=mysql_query($sql) or die("could not update".mysql_error());
echo"<script>alert('Record deleted successfully');</script>";
echo"<meta http-equiv='refresh' content='0;url=add_head.php'>";
