  ...
  <section class="mbr-section info1 cid-rRVpzJ72Ii" id="info1-11">
    ...
    <div class="container">
        <div class="row justify-content-center content-row">
            ...
            <h2 class="align-left mbr-bold mbr-fonts-style display-2">ADD ADMIN</h2>
        ...
        <center>
        <form action="add_admin.php" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
            ...
            <div class="dragArea row">
                ...
                <input type="text" name="name_of_church" placeholder="Name of Church" data-form-field="Email" required="required" class="form-control display-7" id="email-form3-10" style="height:100px;" value="<?php
...
echo "{$row['name_of_church']}";} ?>" disabled>

                <input type="password" name="pass" placeholder="Password" data-form-field="Email" required="required" class="form-control display-7" id="email-form3-10" style="height:100px;">
<br>
<button type="submit" class="btn btn-primary  display-4" name="submit">Submit</button>
             ...
             <?php
                            ...
                            $sql=("INSERT into church_administrator(user,name_of_church,pass) VALUES ('$user','$name_of_church','$pass')");
...
<section class="engine"><a href="https://mobirise.info">Mobirise</a></section><section class="step1 cid-rRVq0hW7PP" id="step1-15">
    ...
    <div class="container">
        <h2 class="mbr-section-title pb-3 mbr-fonts-style align-center display-2">CHURCH ADMINS</h2>
...
$sql="SELECT * from church_administrator";
...
<td><?php echo"<a href='add_delete.php?delete=$row[id]'style='color:orangered'>delete</a>"?></td></tr>
...
for($i=1;$i<=$total_pages;$i++){
    if($i==$page)
echo" <a class='active' href='add_admin.php?page=".$i."'>".$i."</a>&nbsp;";
else
