    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="page1.php"><span class="mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                    My Profile</a>  <a class="btn btn-sm btn-primary display-4" href="page4.php">Send messages</a>           <a class="btn btn-sm btn-primary display-4" href="page3.php"><span class="mobi-mbri mobi-mbri-layers mbr-iconfont mbr-iconfont-btn"></span>Upload</a> <a class="btn btn-sm btn-primary display-4" href="../index/login.php"><span class="mbri-logout mbr-iconfont mbr-iconfont-btn"></span>
                    Logout</a></div>
        </div>
    </nav>
</section>
        ...
        <div class='media-container-row'>
            <div class='mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7'>
                <ul>
                    ...
                    <li><strong>EMAIL ADDRESS</strong> - {$row['email']} </li>
                    <li><strong>DENOMINATION</strong> - {$row['denomination']} <br><a href='page1a.php?edit=$row[id]'>Edit All</a></li>
                    </center>
                    ";}?>
