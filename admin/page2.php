...
<body>
  <section class="mbr-section info1 cid-rRVjFtIDim" id="info1-o">
    ...
    <div class="container">
        <div class="row justify-content-center content-row">
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                ...
                <h2 class="align-left mbr-bold mbr-fonts-style display-2">MY POST</h2>
            </div>
...
<section class="engine"><a href="https://mobirise.info/u">bootstrap html templates</a></section><section class="menu cid-rRVjFuyfJm" once="menu" id="menu2-p">
...
<section class="mbr-section form3 cid-rRVmKBGMr1" id="form3-10">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="align-center pb-2 mbr-fonts-style display-2">
                    SEND & ADVERTISE ON OUR PLATFORM
                </h2>
                <h4 class="mbr-section-subtitle align-center pb-5 mbr-light mbr-fonts-style display-5">
                    Send & advertise on our platform
                </h4>
            </div>
        </div>
        ...
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoids">
                <!---Formbuilder Form--->
                <form action="page2.php" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
...
echo "{$row['email']}";}?>" hidden >     </p>
                     ...
                     <?php
                                    ...
                                    $sql=("INSERT into my_post(messages,timex,mail,image) VALUES ('$messages','$timex','$mail','$image')");
...
<section once="footers" class="cid-rRVjFwYcga mbr-reveal" id="footer7-s">
