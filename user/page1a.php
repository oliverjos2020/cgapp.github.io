    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="page1.php"><span class="mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                    My Profile</a>  <a class="btn btn-sm btn-primary display-4" href="page4.php"><span class="mbrib-letter mbr-iconfont mbr-iconfont-btn"></span>Inbox</a>           <a class="btn btn-sm btn-primary display-4" href="page3.php"><span class="mobi-mbri mobi-mbri-layers mbr-iconfont mbr-iconfont-btn"></span>Event</a> <a class="btn btn-sm btn-primary display-4" href="../index/page2.php"><span class="mbri-logout mbr-iconfont mbr-iconfont-btn"></span>
                    Logout</a></div>
        </div>
    </nav>
</section>
...
$id=$_POST['id'];
if($pass==$pass2){
$sql="UPDATE registration SET fullname='$fullname',country='$country',state='$state',address='address', email='$email',phone='$phone',pass='$pass',pass2='$pass2' WHERE id='$id'";
...
<td></td>Fullname<td><input type="text" name="fullname" value="<?php echo $row[2];?>" class="form-control"></td>
