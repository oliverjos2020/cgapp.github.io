        ...
        <div class="row justify-content-center content-row">
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h3 class="mbr-section-subtitle align-left mbr-light pb-3 mbr-fonts-style display-5">
                    Messages from the Admin of your Church/Organization
                </h3>
                <h2 class="align-left mbr-bold mbr-fonts-style display-2">INBOX</h2>
            </div>
...
$sql="SELECT * from part_church WHERE name_of_church='".$_SESSION['name_of_church']."' order by id desc limit $start_from,$num_per_page";
        ...
        <div class='card p-3 col-12 col-md-6 col-lg-4'>
            <div class='card-wrapper'>
                <div class='card-img'>
                    ...
                    <img style='height:350px;width:400px;'src='../head_admin/images/".$row['image']."' alt='mobirise'>
                </div>
                <div class='card-box'>
                    
                    <h4 class='card-title mbr-fonts-style display-7'>
                    <center><em style='font-size:11px;font-weight:bold;'>{$row['messages']}</em></center>
                    </h4>
                    <h4 class='card-title mbr-fonts-style display-7'>
                    <center><em style='font-size:11px;font-weight:bold;'>Posted at {$row['timex']}</em></center>
                    </h4>
                </div>
            </div>
        </div>
...
$start_from=($page-1)*05;
$sql="SELECT * from messages WHERE name_of_church='".$_SESSION['name_of_church']."' order by id desc limit $start_from,$num_per_page";
$rs_result=mysql_query($sql);
?>
          <?php
while($row=mysql_fetch_array($rs_result,MYSQL_ASSOC)){
