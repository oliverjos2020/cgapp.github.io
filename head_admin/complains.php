        ...
        <div class="row main justify-content-center">
            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-left py-4"><a class="btn btn-primary display-4" href="https://mobirise.co"><span class="mbri-like mbr-iconfont mbr-iconfont-btn"></span>
                    TESTED &amp; TRUSTED</a> <a class="btn btn-primary display-4" href="page1.php"><span class="mbri-left mbr-iconfont mbr-iconfont-btn"></span>
                    Back</a></div>
            </div>
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">A USERNAME AND PASSWORD IS REQUIRED TO ACCESS THIS PAGE</h2>
    ...
    <div class="container">
        ...
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoids">
                <!---Formbuilder Form--->
                <form action="complains.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="CAP//6gjVfYzssHah+ZTDc30RudR95idjfSi9ikU5WA8hQJYWr5Dgu5pwS0C5bXKx0iCx41VmTxbkco35dgvETBwbVoFm4hhazX0a05cdGBiGQYHVga6bazMMxP4rSFh">
                    <div class="row">
...
$user=$_POST['user'];
$pass=$_POST['pass'];
$result = mysqli_query($connect, 'SELECT * FROM add_head_admin WHERE user="'.$user.'" AND pass="'.$pass.'"');
if(mysqli_num_rows($result)==1){
echo"<script>alert('Access Granted...'); window.location='complain.php';</script>";
}
else{
