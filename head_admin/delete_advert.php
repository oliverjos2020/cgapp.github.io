    ...
    <div class="container">
        <div class="row main justify-content-center">
            ...
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">DELETE ADVERT</h2>
...
$id=$_GET['delete'];
$sql=mysql_query("SELECT * FROM advert WHERE id='$id'");
...
?>
<form action="delete_advert.php" method="POST">
