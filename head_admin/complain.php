    ...
    <div class="container">
        <div class="row main justify-content-center">
            ...
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">COMPLAIN</h2>
...
$sql="SELECT * from complain order by id desc limit $start_from,$num_per_page";
...
for($i=1;$i<=$total_pages;$i++){
    if($i==$page)
echo" <a class='active' href='complain.php?page=".$i."'>".$i."</a>&nbsp;";
else
echo'<a href="complain.php?page='.$i.'">'.$i.'</a>';
    }
    echo"</div>";
    ?></center>
            <!--Card-5-->
