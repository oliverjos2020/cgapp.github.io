...
$result= mysql_query("SELECT COUNT(name_of_church) AS totalsum FROM registration ");
...
$sql="select * from registration limit $start_from,$num_per_page";
...
for($i=1;$i<=$total_pages;$i++){
    if($i==$page)
echo" <a class='active' href='reg_mems.php?page=".$i."'>".$i."</a>&nbsp;";
else
echo'<a href="reg_mems.php?page='.$i.'">'.$i.'</a>';
    }
    echo"</div>";
?>
     </center>      
