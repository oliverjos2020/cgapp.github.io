    ...
    <div class="container">
        <div class="row main justify-content-center">
            ...
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">GET INFORMED</h2>
    ...
    <div class="container">
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoids">
                <!---Formbuilder Form--->
                <form action="get_informed.php" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
...
<button type="submit" class="btn btn-primary  display-4" name="submit">Submit</button>
             ...
             <?php
                            ...
                            $sql=("INSERT into get_informed(messages,timex,image) VALUES ('$messages','$timex','$image')");
                            ...
                            if(move_uploaded_file($_FILES['image']['tmp_name'],$target)){
                                ...
                                echo"<script>alert('Get informed posted successfully');</script>";
                            ...
                            <div class='col-12 col-md-10'>
                                <div class='wrapper'>
                                    ...
                                    <div class='bottom-line'>
                                        <p class='mbr-text mbr-fonts-style display-7'>
                                            TIME OF POST {$row['timex']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='delete_get_informed.php?delete=$row[id]'style='color:orangered'>delete</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
