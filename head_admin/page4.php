    ...
    <div class="container">
        <div class="row main justify-content-center">
            ...
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">LATEST</h2>
    ...
    <div class="container">
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoids">
                <!---Formbuilder Form--->
                <form action="page4.php" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
...
<button type="submit" class="btn btn-primary  display-4" name="submit">Submit</button>
             ...
             <?php
                            ...
                            $sql=("INSERT into latest(messages,name_of_church,timex,image) VALUES ('$messages','$name_of_church','$timex','$image')");
...
$sql="SELECT * from latest order by id desc limit $start_from,$num_per_page";
$rs_result=mysql_query($sql);
?>
          <?php
while($row=mysql_fetch_array($rs_result,MYSQL_ASSOC)){
            ...
            <div class='card col-12 pb-5'>
                <div class='card-wrapper media-container-row media-container-row'>
                    ...
                    <div class='row'>
                                ...
                                <img style='max-height:150px;'src='images/".$row['image']."'>
                                </div>
                                <div class='card-box'>
                        <div class='row'>
                            ...
                            <div class='col-12 col-md-10'>
                                <div class='wrapper'>
                                    ...
                                    <p class='mbr-text mbr-fonts-style display-7'>
                                    TIME OF POST<em>' {$row['timex']}'</em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='delete_latest.php?delete=$row[id]'style='color:orangered'>delete</a>
                                </p>
                                    </div>
...
for($i=1;$i<=$total_pages;$i++){
    if($i==$page)
echo" <a class='active' href='page4.php?page=".$i."'>".$i."</a>&nbsp;";
else
echo'<a href="page4.php?page='.$i.'">'.$i.'</a>';
    }
    echo"</div>";
?></center>
            <!--Card-5-->
