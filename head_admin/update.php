    ...
    <div class="container">
        <div class="row main justify-content-center">
            ...
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">EDIT HEAD ADMIN</h2>
...
$pass=$_POST['pass'];
$id=$_POST['id'];
$sql="UPDATE head_administrator SET user='$user', pass='$pass' WHERE id='$id'";
...
<td></td>Username<td><input type="text" name="user" value="<?php echo $row[1];?>" class="form-control"></td>
<td></td>Password<td><input type="text" name="pass" value="<?php echo $row[2];?>" class="form-control"></td>
