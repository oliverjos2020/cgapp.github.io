...
<section class='mbr-section article content12 cid-rRVitkZuGU' id='content12-m'>
    ...
    <div class="container">
        ...
        <form action="reg_memas.php" method="POST">
        <?php
...
$id=$_POST['id'];
if($pass==$pass2){
$sql="UPDATE registration SET name_of_church='$name_of_church', email='$email',phone='$phone',country='$country',state='$state',address='$address',pass='$pass',pass2='$pass2' WHERE id='$id'";
