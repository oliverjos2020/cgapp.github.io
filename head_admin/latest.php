    ...
    <div class="container">
        ...
        <div class="row py-2 justify-content-center">
            <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoids">
                <!---Formbuilder Form--->
                <form action="latest.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="CAP//6gjVfYzssHah+ZTDc30RudR95idjfSi9ikU5WA8hQJYWr5Dgu5pwS0C5bXKx0iCx41VmTxbkco35dgvETBwbVoFm4hhazX0a05cdGBiGQYHVga6bazMMxP4rSFh">
                    <div class="row">
...
echo"<script>alert('Access Granted...'); window.location='page4.php';</script>";
}
else{
