    ...
    <div class="container">
        <div class="row main justify-content-center">
            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-left py-4"><a class="btn btn-primary display-4" href="part_church2.php"><span class="mbri-left mbr-iconfont mbr-iconfont-btn"></span>
                    BACK</a></div>
            </div>
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">DELETE PARTICULAR CHURCH NOTIFICATION</h2>
...
$id=$_GET['delete'];
$sql=mysql_query("SELECT * FROM notification WHERE id='$id'");
...
echo"<meta http-equiv='refresh' content='0;url=part_church2.php'>";


}
?>
<form action="delete_part2.php" method="POST">
