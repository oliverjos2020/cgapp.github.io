    ...
    <div class="container">
        <div class="row main justify-content-center">
            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-left py-4"><a class="btn btn-primary display-4" href="part_church.php"><span class="mbri-left mbr-iconfont mbr-iconfont-btn"></span>
                    BACK</a></div>
            </div>
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h2 class="align-right mbr-bold mbr-white pb-3 mbr-fonts-style display-2">DELETE PARTICULAR CHURCH ADVERT</h2>
...
$id=$_GET['delete'];
$sql=mysql_query("SELECT * FROM part_church WHERE id='$id'");
$row=mysql_fetch_array($sql);
}
if(isset($_POST['delete'])){
$id=$_POST['id'];
$sql="DELETE FROM part_church WHERE id='$id'";
$res=mysql_query($sql) or die("could not update".mysql_error());
echo"<script>alert('Record deleted successfully');</script>";
echo"<meta http-equiv='refresh' content='0;url=part_church.php'>";
